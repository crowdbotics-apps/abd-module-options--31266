...
## Project Structure
    ...
    ├── abd_module_options__31266  # Django project configurations
...
1. Clone this repo and `cd abd_module_options__31266`
...
2. Clone this repo and `cd abd_module_options__31266`
